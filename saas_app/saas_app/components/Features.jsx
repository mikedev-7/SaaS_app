...
const featuresData = [
  {
    imgSrc: "/assets/features/img-1.svg",
  ...
  {
    imgSrc: "/assets/features/img-2.svg",
  ...
  {
    imgSrc: "/assets/features/img-3.svg",
  ...
  {
    imgSrc: "/assets/features/img-4.svg",
    ...
    <section className="text-white pt-32 relative">
      <div className="container mx-auto">
        <div className="flex gap-16">
          {/* img */}
          <motion.div key={featuresData[index].imgSrc} 
            initial={{opacity: 0}} 
            animate={{opacity: 1}} 
            transition={{duration:0.4, ease: [0.6, -0.05, 0.01, 0.99], 
            delay: 0.2,
          }} 
          className="hidden xl:flex justify-center flex-1 w-full h-f[480px] sticky top-[calc(50%-240px)]"
          >  
