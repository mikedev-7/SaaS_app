        ...
        <div className='container mx-auto h-full flex items-center xl:items-start'>
            ...
            >
                <h1 className='text-[60px] font-bold tracking-[-0.5px] leading-none max-w-[800px] xl:max-w-max'>
                    Boost Your Produtivity Instantly
                </h1>
                <p className='max-w-[680px] text-[20px] text-white/80 font-light px-8 xl:px-0 mb-2'>
                    StreamLine tasks and manage your time effortlessly with our powerful, intuitive, 
                    all in one productivity platform.
                </p>
                <Button btnText="Join today" />
            </motion.div>
            {/* img */}
            <motion.div className='hidden xl:flex w-full max-w-[960px] mx-auto h-[520px] bg-no-repeat sticky left-0 right-0' style={{
                backgroundImage: "url('/assets/hero/img.svg')",
